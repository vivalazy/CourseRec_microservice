...
public class UserController {
    ...
    public List<User> findByUserid(@RequestParam(value = "userid")String userid){
    ...
    public String save(){
        // 内存数据库操作
        userService.save(new User("4","1234","19", "haha"));
        userService.save(new User("3","1234","18", "haha"));
        userService.save(new User("5","1234","17", "haha"));
